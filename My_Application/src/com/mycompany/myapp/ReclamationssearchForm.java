...
public class ReclamationssearchForm extends SideMenuBaseForm{
    
    public ReclamationssearchForm(Resources res,String search){
      ...
      Button searchbutton = new Button("search");
        ...
        */
        ...
        con.setUrl("http://127.0.0.1:8000/searchededjson?search="+search);
